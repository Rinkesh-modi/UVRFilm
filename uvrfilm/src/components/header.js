  ...
  return (
    <header className=" fixed w-full top-0 grid sm:grid-cols-12 gap-6 py-5 px-20 bg-transparent text-white">
      ...
      <div className="sm:col-span-7 ">
        <ul className="hidden lg:flex items-center font-medium gap-8 lg:gap-12 font-poppins uppercase py-1">
          <li className="ease-linear duration-300 transition-all hover:text-rose-500 cursor-pointer">
            <a href="/">Home</a>
          </li>
          <li className="ease-linear duration-300 transition-all hover:text-rose-500 cursor-pointer">
            <a href="/">About Us</a>
